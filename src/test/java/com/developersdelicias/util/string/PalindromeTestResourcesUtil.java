...
public class PalindromeTestResourcesUtil {
	...
	static {
		...
		lowComplexityPalindromesList
				.add(new PalindromeTestResource("oso", "Single palindrome with one word and all letters in lowercase"));
		...
		lowComplexityPalindromesList.add(new PalindromeTestResource("1", "Single integer number"));
		lowComplexityPalindromesList.add(new PalindromeTestResource("44", "Two repeated integer numbers"));
		lowComplexityPalindromesList.add(new PalindromeTestResource("121", "A palindrome with three integer numbers"));
		lowComplexityPalindromesList.add(new PalindromeTestResource("1221", "A palindrome with four integer numbers"));
		lowComplexityPalindromesList.add(new PalindromeTestResource("12321", "A palindrome with five integer numbers"));

		mediumComplexityPalindromesList = new ArrayList<>();
		mediumComplexityPalindromesList.add(
				new PalindromeTestResource("No 'x' in Nixon", "A palindrome with four words that has apostrophes"));
		...
		mediumComplexityPalindromesList.add(
				new PalindromeTestResource("Marge lets Norah see Sharon’s telegram.", "A palindrome with six words"));
		mediumComplexityPalindromesList
				.add(new PalindromeTestResource("123321", "A palindrome with six integer numbers"));
		mediumComplexityPalindromesList
				.add(new PalindromeTestResource("1234321", "A palindrome with seven integer numbers"));
		mediumComplexityPalindromesList
				.add(new PalindromeTestResource("12344321", "A palindrome with eight integer numbers"));
		mediumComplexityPalindromesList
				.add(new PalindromeTestResource("123454321", "A palindrome with nine integer numbers"));
		mediumComplexityPalindromesList
				.add(new PalindromeTestResource("1234554321", "A palindrome with nine integer numbers"));
		...
		highComplexityPalindromesList.add(new PalindromeTestResource(
		...
		highComplexityPalindromesList
				.add(new PalindromeTestResource("12345654321", "A palindrome with ten integer numbers"));
		...
		realPalindromesList.add(
				new PalindromeTestResource("Race car", "Single palindrome with two words using capital first letter"));
		...
		realPalindromesList.add(new PalindromeTestResource("123454321", "Integer number palindrome"));
		realPalindromesList.add(new PalindromeTestResource("1234.4321", "Decimal number palindrome"));

		invalidPalindromesList = new ArrayList<>();
		invalidPalindromesList
				.add(new PalindromeTestResource("it is not a palindrome", "Any string that is not a palindrome"));
